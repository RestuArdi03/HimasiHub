...
class AnggotaController extends Controller
{
    ...
    public function update(Request $request, Anggota $anggota)
    {
        ...
        DB::transaction(function () use ($validated, $anggota, $userId, $newRoleId) { 
            ...
            $user->update([
                'nama' => $validated['nama'],
                // Jika Anda memang memiliki email di form, biarkan. 
                // Jika tidak, hapus kunci 'email' dari $validated di luar transaksi.
                // Saya asumsikan Anda ingin memperbarui email:
                'email' => $validated['email'],
                
                // 🔥 KOREKSI ROLE_ID: Masukkan role_id baru ke dalam update user
                'role_id' => $newRoleId, 
            ]);
