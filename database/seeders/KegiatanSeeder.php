...
class KegiatanSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if (!$pimpinan) {
            $this->command->warn('User tidak ditemukan. Lewati KegiatanSeeder. Jalankan UserSeeder terlebih dahulu.');
            return;
        }
        ...
        foreach ($kegiatanData as $data) {
            Kegiatan::create($data + ['pimpinan_kegiatan_id' => $pimpinanKegiatan->id]);
        }
